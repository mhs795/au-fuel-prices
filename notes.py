...
SECTIONS = [
    ...
    ("SUMMARY CHARTS TAB", [
        ("What it is", "Seventeen native Excel charts - every series at daily, monthly, quarterly and annual frequency, plus one two-scale chart. They are real charts pointing at cells on the data tabs, not pictures, so they redraw whenever the workbook is rebuilt and can be copied straight into a document or deck."),
        ("Daily charts are windowed", "The daily charts show the last two years only. Full daily history is on the daily tabs; twenty-eight years of daily spot prices in a chart this size is a solid block of ink."),
